...
export default function Navbar() {
    ...
    return (
        <nav className={`bg-white/90 backdrop-blur-md shadow-sm fixed w-full top-0 z-50 border-b border-gray-100 transition-all duration-500 ease-in-out py-0`}>
            {/* Top Bar - Hide on scroll for extra shrinking */}
                ...
                {isOpen && (
                    ...
                    >
                        <div className="p-6 flex flex-col space-y-4 font-medium text-gray-700">
                            <Link href="/" className="hover:text-medical-teal-600 py-2 border-b border-gray-50" onClick={() => setIsOpen(false)}>Home</Link>
                            ...
                            <Link href="/services" className="hover:text-medical-teal-600 py-2 border-b border-gray-50" onClick={() => setIsOpen(false)}>Services</Link>
                            <Link href="/packages" className="hover:text-medical-teal-600 py-2 border-b border-gray-50" onClick={() => setIsOpen(false)}>Packages</Link>
                            <Link href="/doctors" className="hover:text-medical-teal-600 py-2 border-b border-gray-50" onClick={() => setIsOpen(false)}>Doctors</Link>
                            <Link href="/contact" className="hover:text-medical-teal-600 py-2 border-b border-gray-50" onClick={() => setIsOpen(false)}>Contact</Link>
