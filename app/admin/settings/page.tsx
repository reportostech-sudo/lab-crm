...
import { updateLogo, toggleMaintenance, getMaintenanceStatus, clearSystemCache, checkPgDumpAvailability } from '@/app/lib/settings-actions';
import { Loader2, Upload, Database, Image as ImageIcon, Save, Download, AlertTriangle, Power, RefreshCw, Trash2, FileJson, AlertCircle } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    // Fetch initial maintenance status and pg_dump availability
    useEffect(() => {
